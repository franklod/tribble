<div class="g75">
  <div class="tribble-container">
    <div class="tribble-user-info"> <a href="/" title="Kubilay Sapayer"><img src="http://tribble.local/data/b5e0eaebec229148d61d1881b27d1865e1bb5003/dispic2_thumb.jpg" alt="Logobig" width="54" height="54"/></a>
      <div class="tribble-title">
        <h2>twitter app iOS</h2>
      </div>
      <h4><a href="/">Username</a></h4>
      <div class="tribble-date">aasdasd</div>
    </div>
    <div class="tribble-img-container box clear"> <img src="" width="400" height="300"/></div>
    <div class="tribble-img-data">
      <div class="tribble-desc">
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
      </div>
      <div class="tribble-tools">
        <p class="ico"><a href="/" class="likes">20</a></p>
      </div>
      <h3>Tags</h3>
      <ul class="tags">
        <li><a href="/">jfsdfsdfsfshkh</a></li>
        <li><a href="/">jhsdfsdkh</a></li>
        <li><a href="/">jhksfh</a></li>
        <li><a href="/">jhsdfsdkh</a></li>
      </ul>
      <h3>Color Scheme</h3>

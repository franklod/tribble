<div class="g75 box">
  ...
  <div class="e_wrap <?=(form_error('old_password') == TRUE) ? 'error' : ''; ?>">
  ...
  <div class="e_wrap <?=(form_error('new_password') == TRUE) ? 'error' : ''; ?>">
  ...
  <div class="e_wrap <?=(form_error('retype_new_password') == TRUE) ? 'error' : ''; ?>">
    <?=form_label('Confirm new password','retype_new_password')?>
    <?=form_password(array('name'=>'retype_new_password','id'=>'retype_new_password'))?>
    <?=(form_error('retype_new_password') == TRUE) ? form_error('retype_new_password') : ''; ?>
  </div>    
  <div class="e_wrap">
